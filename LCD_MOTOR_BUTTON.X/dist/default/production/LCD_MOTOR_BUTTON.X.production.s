...
TOSU equ 0FFFh ;# 
	...
	FNCALL	_main,_start_func
	FNCALL	_start_func,_delay
...
; #config settings
	...
	file	"dist/default/production\LCD_MOTOR_BUTTON.X.production.s"
	line	#
...
delay@i:	; 4 bytes @ 0x5
	ds   4
??_start_func:	; 1 bytes @ 0x9
??_data:	; 1 bytes @ 0x9
	global	start_func@a
start_func@a:	; 1 bytes @ 0x9
	global	data@a
data@a:	; 1 bytes @ 0x9
	ds   1
?_display:	; 1 bytes @ 0xA
	global	display@p
display@p:	; 1 bytes @ 0xA
	ds   1
??_display:	; 1 bytes @ 0xB
??_main:	; 1 bytes @ 0xB
	global	main@i
main@i:	; 2 bytes @ 0xB
	ds   2
...
;; *************** function _main *****************
;; Defined at:
;;		line 43 in file "LCD_MOTOR_BUTTON.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;  i               2   11[COMRAM] int 
;;  count           2   13[COMRAM] int 
...
l865:
;LCD_MOTOR_BUTTON.c: 45:     TRISC=0x01;
	movlw	low(01h)
	movwf	((c:3988))^0f00h,c	;volatile
	line	46
;LCD_MOTOR_BUTTON.c: 46:     TRISD=0x00;
	movlw	low(0)
	movwf	((c:3989))^0f00h,c	;volatile
	line	47
;LCD_MOTOR_BUTTON.c: 47:     int count=0;
	movlw	high(0)
...
l867:
;LCD_MOTOR_BUTTON.c: 49:     {;LCD_MOTOR_BUTTON.c: 50:         if(RC0==1 && count==0)
...
l869:
	movf	((c:main@count))^00h,c,w
iorwf	((c:main@count+1))^00h,c,w
	btfss	status,2
	goto	u151
	goto	u150
...
l871:
;LCD_MOTOR_BUTTON.c: 51:         {;LCD_MOTOR_BUTTON.c: 52:             RC1=1; RC2=0;
...
l875:
;LCD_MOTOR_BUTTON.c: 54:             start_func(0x01);
	movlw	(01h)&0ffh
...
l877:
;LCD_MOTOR_BUTTON.c: 55:             start_func(0x0f);
	movlw	(0Fh)&0ffh
...
l879:
;LCD_MOTOR_BUTTON.c: 56:             display("Clockwise");
		movlw	low(STR_1)
...
l881:
;LCD_MOTOR_BUTTON.c: 58:             {;LCD_MOTOR_BUTTON.c: 59:                 for(int i=0;i<32;i++)
	movlw	high(0)
...
l887:
;LCD_MOTOR_BUTTON.c: 60:                 {;LCD_MOTOR_BUTTON.c: 61:                     start_func(0x18);
	movlw	(018h)&0ffh
	
	call	_start_func
	line	62
;LCD_MOTOR_BUTTON.c: 62:                     delay(5000);
	movlw	low(01388h)
	movwf	((c:delay@j))^00h,c
	movlw	high(01388h)
	movwf	((c:delay@j+1))^00h,c
	movlw	low highword(01388h)
	movwf	((c:delay@j+2))^00h,c
	movlw	high highword(01388h)
	movwf	((c:delay@j+3))^00h,c
	call	_delay	;wreg free
	line	63
	
l889:
;LCD_MOTOR_BUTTON.c: 63:                 }
...
l893:
;LCD_MOTOR_BUTTON.c: 64:                 start_func(0x02);
	movlw	(02h)&0ffh
	
	call	_start_func
	goto	l881
	line	68
;LCD_MOTOR_BUTTON.c: 68:         else if(RC0==1 && count==1)
...
l897:
;LCD_MOTOR_BUTTON.c: 69:         {;LCD_MOTOR_BUTTON.c: 70:             RC1=0;RC2=1;
	bcf	c:(31761/8),(31761)&7	;volatile
	bsf	c:(31762/8),(31762)&7	;volatile
	line	71
	
l899:
;LCD_MOTOR_BUTTON.c: 71:             count=2;
	movlw	high(02h)
	movwf	((c:main@count+1))^00h,c
	movlw	low(02h)
	movwf	((c:main@count))^00h,c
...
l901:
;LCD_MOTOR_BUTTON.c: 72:             start_func(0x01);
	movlw	(01h)&0ffh
...
l903:
;LCD_MOTOR_BUTTON.c: 73:             start_func(0x0f);
	movlw	(0Fh)&0ffh
...
l905:
;LCD_MOTOR_BUTTON.c: 75:             display("Anticlockwise");
		movlw	low(STR_2)
	movwf	((c:display@p))^00h,c

	call	_display	;wreg free
	line	76
;LCD_MOTOR_BUTTON.c: 76:             while(RC0==0);
...
u190:
	goto	l867
	line	78
;LCD_MOTOR_BUTTON.c: 78:         else if(RC0==1 && count==2)
...
l909:
;LCD_MOTOR_BUTTON.c: 79:         {;LCD_MOTOR_BUTTON.c: 80:             RC1=0;RC2=0;
	bcf	c:(31761/8),(31761)&7	;volatile
	bcf	c:(31762/8),(31762)&7	;volatile
	line	81
	
l911:
;LCD_MOTOR_BUTTON.c: 81:             count=0;
	movlw	high(0)
	movwf	((c:main@count+1))^00h,c
	movlw	low(0)
	movwf	((c:main@count))^00h,c
...
l913:
;LCD_MOTOR_BUTTON.c: 82:             start_func(0x01);
	movlw	(01h)&0ffh
...
l915:
;LCD_MOTOR_BUTTON.c: 83:             start_func(0x0f);
	movlw	(0Fh)&0ffh
...
l917:
;LCD_MOTOR_BUTTON.c: 84:             display("Stopped");
		movlw	low(STR_3)
	movwf	((c:display@p))^00h,c

	call	_display	;wreg free
	line	85
;LCD_MOTOR_BUTTON.c: 85:             while(RC0==0);
...
;; Defined at:
;;		line 14 in file "LCD_MOTOR_BUTTON.c"
;; Parameters:    Size  Location     Type
...
;incstack = 0
	callstack 29
;start_func@a stored from wreg
	movwf	((c:start_func@a))^00h,c
	line	16
	
l845:
;LCD_MOTOR_BUTTON.c: 14: void start_func(unsigned char a);LCD_MOTOR_BUTTON.c: 15: {;LCD_MOTOR_BUTTON.c: 16:     RC3=0;
	bcf	c:(31763/8),(31763)&7	;volatile
	line	17
;LCD_MOTOR_BUTTON.c: 17:     RC4=0;
	bcf	c:(31764/8),(31764)&7	;volatile
	line	18
	
l847:
;LCD_MOTOR_BUTTON.c: 18:     PORTD=a;
	movff	(c:start_func@a),(c:3971)	;volatile
	line	19
	
l849:
;LCD_MOTOR_BUTTON.c: 19:     RC5=1;
	bsf	c:(31765/8),(31765)&7	;volatile
	line	20
	
l851:
;LCD_MOTOR_BUTTON.c: 20:     delay(100);
	movlw	low(064h)
	movwf	((c:delay@j))^00h,c
	movlw	high(064h)
	movwf	((c:delay@j+1))^00h,c
...
l853:
;LCD_MOTOR_BUTTON.c: 21:     RC5=0;
	bcf	c:(31765/8),(31765)&7	;volatile
	line	22
	
l855:
;LCD_MOTOR_BUTTON.c: 22:     delay(5000);
	movlw	low(01388h)
	movwf	((c:delay@j))^00h,c
	movlw	high(01388h)
	movwf	((c:delay@j+1))^00h,c
...
l27:
	return	;funcret
	callstack 0
GLOBAL	__end_of_start_func
	__end_of_start_func:
	signat	_start_func,4217
	global	_display

;; *************** function _display *****************
;; Defined at:
;;		line 35 in file "LCD_MOTOR_BUTTON.c"
;; Parameters:    Size  Location     Type
;;  p               1   10[COMRAM] PTR const unsigned char 
;;		 -> STR_3(8), STR_2(14), STR_1(10), 
;; Auto vars:     Size  Location     Type
;;		None
;; Return value:  Size  Location     Type
;;                  1    wreg      void 
...
l857:
;LCD_MOTOR_BUTTON.c: 35: void display(const char *p);LCD_MOTOR_BUTTON.c: 36: {;LCD_MOTOR_BUTTON.c: 37:     while(*p)
	goto	l863
	line	39
	
l859:
;LCD_MOTOR_BUTTON.c: 38:     {;LCD_MOTOR_BUTTON.c: 39:         data(*p);
...
l861:
;LCD_MOTOR_BUTTON.c: 40:         p++;
	incf	((c:display@p))^00h,c
	line	37
	
l863:
;LCD_MOTOR_BUTTON.c: 37:     while(*p)
	movff	(c:display@p),tblptrl
	if	0	;There is only one active tblptr byte
	global __smallconst
movlw	high(__smallconst)
...
;; *************** function _data *****************
;; Defined at:
;;		line 24 in file "LCD_MOTOR_BUTTON.c"
;; Parameters:    Size  Location     Type
;;  a               1    wreg     unsigned char 
;; Auto vars:     Size  Location     Type
;;  a               1    9[COMRAM] unsigned char 
...
;incstack = 0
	callstack 28
;data@a stored from wreg
	movwf	((c:data@a))^00h,c
	line	26
	
l833:
;LCD_MOTOR_BUTTON.c: 24: void data(unsigned char a);LCD_MOTOR_BUTTON.c: 25: {;LCD_MOTOR_BUTTON.c: 26:     RC3=1;
	bsf	c:(31763/8),(31763)&7	;volatile
	line	27
;LCD_MOTOR_BUTTON.c: 27:     RC4=0;
	bcf	c:(31764/8),(31764)&7	;volatile
	line	28
	
l835:
;LCD_MOTOR_BUTTON.c: 28:     PORTD=a;
	movff	(c:data@a),(c:3971)	;volatile
	line	29
	
l837:
;LCD_MOTOR_BUTTON.c: 29:     RC5=1;
	bsf	c:(31765/8),(31765)&7	;volatile
	line	30
	
l839:
;LCD_MOTOR_BUTTON.c: 30:     delay(100);
	movlw	low(064h)
	movwf	((c:delay@j))^00h,c
	movlw	high(064h)
	movwf	((c:delay@j+1))^00h,c
...
l841:
;LCD_MOTOR_BUTTON.c: 32:     RC5=0;
	bcf	c:(31765/8),(31765)&7	;volatile
	line	33
	
l843:
;LCD_MOTOR_BUTTON.c: 33:     delay(5000);
	movlw	low(01388h)
	movwf	((c:delay@j))^00h,c
	movlw	high(01388h)
	movwf	((c:delay@j+1))^00h,c
...
;; *************** function _delay *****************
;; Defined at:
;;		line 10 in file "LCD_MOTOR_BUTTON.c"
;; Parameters:    Size  Location     Type
;;  j               4    0[COMRAM] long 
;; Auto vars:     Size  Location     Type
;;  i               4    5[COMRAM] long 
...
l829:
;LCD_MOTOR_BUTTON.c: 10: void delay(long j);LCD_MOTOR_BUTTON.c: 11: {;LCD_MOTOR_BUTTON.c: 12:     for(long i=0;i<=j;i++);
	movlw	low(0)
	movwf	((c:delay@i))^00h,c
	movlw	high(0)
	movwf	((c:delay@i+1))^00h,c
	movlw	low highword(0)
	movwf	((c:delay@i+2))^00h,c
	movlw	high highword(0)
	movwf	((c:delay@i+3))^00h,c
	goto	l21
	
l831:
	movlw	low(01h)
	addwf	((c:delay@i))^00h,c
	movlw	0
	addwfc	((c:delay@i+1))^00h,c
	addwfc	((c:delay@i+2))^00h,c
	addwfc	((c:delay@i+3))^00h,c
	
l21:
		movf	((c:delay@i))^00h,c,w
	subwf	((c:delay@j))^00h,c,w
	movf	((c:delay@i+1))^00h,c,w
	subwfb	((c:delay@j+1))^00h,c,w
	movf	((c:delay@i+2))^00h,c,w
	subwfb	((c:delay@j+2))^00h,c,w
	movf	((c:delay@j+3))^00h,c,w
	xorlw	80h
	movwf	(??_delay+0+0)^00h,c
	movf	((c:delay@i+3))^00h,c,w
	xorlw	80h
