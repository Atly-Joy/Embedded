...
; #config settings
	...
	file	"dist/default/production\NameScroll_LCD.X.production.s"
	line	#
...
;; *************** function _main *****************
;; Defined at:
;;		line 45 in file "NameScroll.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;  count           2   11[COMRAM] int 
...
l815:
;NameScroll.c: 47:     TRISC=0x08;
	movlw	low(08h)
	movwf	((c:3988))^0f00h,c	;volatile
	line	48
;NameScroll.c: 48:     TRISD=0x00;
	movlw	low(0)
	movwf	((c:3989))^0f00h,c	;volatile
	line	49
;NameScroll.c: 49:     int count=0;
	movlw	high(0)
...
l817:
;NameScroll.c: 51:     {;NameScroll.c: 52:         start_func(0x01);
	movlw	(01h)&0ffh
...
l819:
;NameScroll.c: 53:         start_func(0x0f);
	movlw	(0Fh)&0ffh
...
l821:
;NameScroll.c: 54:         start_func(0x0f);
	movlw	(0Fh)&0ffh
...
l825:
;NameScroll.c: 57:             {;NameScroll.c: 64:                 if(RC3==1 && count>=0)
...
l829:
;NameScroll.c: 65:                 {;NameScroll.c: 66:                     start_func(0x10);
	movlw	(010h)&0ffh
	
	call	_start_func
	line	67
;NameScroll.c: 67:                     data(' ');
	movlw	(020h)&0ffh
	
	call	_data
	line	68
;NameScroll.c: 68:                     start_func(0x10);
	movlw	(010h)&0ffh
...
l795:
;NameScroll.c: 15: void start_func(unsigned char a);NameScroll.c: 16: {;NameScroll.c: 17:     RC0=0;
	bcf	c:(31760/8),(31760)&7	;volatile
	line	18
;NameScroll.c: 18:     RC1=0;
	bcf	c:(31761/8),(31761)&7	;volatile
	line	19
	
l797:
;NameScroll.c: 19:     PORTD=a;
	movff	(c:start_func@a),(c:3971)	;volatile
	line	20
	
l799:
;NameScroll.c: 20:     RC2=1;
	bsf	c:(31762/8),(31762)&7	;volatile
	line	21
	
l801:
;NameScroll.c: 21:     delay(100);
	movlw	low(064h)
...
l803:
;NameScroll.c: 22:     RC2=0;
	bcf	c:(31762/8),(31762)&7	;volatile
	line	23
	
l805:
;NameScroll.c: 23:     delay(5000);
	movlw	low(01388h)
	movwf	((c:delay@j))^00h,c
	movlw	high(01388h)
	movwf	((c:delay@j+1))^00h,c
...
l807:
;NameScroll.c: 36: void display(const char *p);NameScroll.c: 37: {;NameScroll.c: 38:     while(*p)
	goto	l813
	line	40
	
l809:
;NameScroll.c: 39:     {;NameScroll.c: 40:         data(*p);
...
l783:
;NameScroll.c: 25: void data(unsigned char a);NameScroll.c: 26: {;NameScroll.c: 27:     RC0=1;
	bsf	c:(31760/8),(31760)&7	;volatile
	line	28
;NameScroll.c: 28:     RC1=0;
	bcf	c:(31761/8),(31761)&7	;volatile
	line	29
	
l785:
;NameScroll.c: 29:     PORTD=a;
	movff	(c:data@a),(c:3971)	;volatile
	line	30
	
l787:
;NameScroll.c: 30:     RC2=1;
	bsf	c:(31762/8),(31762)&7	;volatile
	line	31
	
l789:
;NameScroll.c: 31:     delay(100);
	movlw	low(064h)
	movwf	((c:delay@j))^00h,c
	movlw	high(064h)
	movwf	((c:delay@j+1))^00h,c
...
l791:
;NameScroll.c: 33:     RC2=0;
	bcf	c:(31762/8),(31762)&7	;volatile
	line	34
	
l793:
;NameScroll.c: 34:     delay(5000);
	movlw	low(01388h)
	movwf	((c:delay@j))^00h,c
	movlw	high(01388h)
	movwf	((c:delay@j+1))^00h,c
...
l779:
;NameScroll.c: 11: void delay(long j);NameScroll.c: 12: {;NameScroll.c: 13:     for(long i=0;i<=j;i++);
	movlw	low(0)
