...
; #config settings
	...
	file	"dist/default/production\Motordrive_L293D.X.production.s"
	line	#
...
;; *************** function _main *****************
;; Defined at:
;;		line 15 in file "L293D.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;  count2          2    2[COMRAM] int 
;;  count1          2    0[COMRAM] int 
...
l736:
	...
	line	19
	movlw	high(0)
	movwf	((c:main@count1+1))^00h,c
	movlw	low(0)
	movwf	((c:main@count1))^00h,c
	movlw	high(0)
	movwf	((c:main@count2+1))^00h,c
	movlw	low(0)
	movwf	((c:main@count2))^00h,c
	line	22
...
l740:
	movf	((c:main@count1))^00h,c,w
iorwf	((c:main@count1+1))^00h,c,w
	btfss	status,2
	goto	u31
	goto	u30
...
l758:
	movf	((c:main@count2))^00h,c,w
iorwf	((c:main@count2+1))^00h,c,w
	btfss	status,2
	goto	u121
	goto	u120
